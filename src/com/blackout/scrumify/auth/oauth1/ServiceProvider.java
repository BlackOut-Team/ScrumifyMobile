 ...
 */
package com.blackout.scrumify.auth.oauth1;
...
public class ServiceProvider {
	...
	public String getAuthenticateUrl(RequestToken requestToken) {
		return authenticateUrl + '?' + RequestToken.TOKEN + '='
				+ "EY3scmLP_5AAAAAAAAAAntf8yFV01qybt6DgG91YwXpw2UPCAhmGwUnLJaEV2u24" + "&oauth_callback=" + requestToken.getCallback();
	}
	...
	public String getAuthorizeUrl(RequestToken requestToken) {
		return authorizeUrl + '?' + RequestToken.TOKEN + '='
				+ requestToken.getToken() + "&oauth_callback=" + requestToken.getCallback();
	}
