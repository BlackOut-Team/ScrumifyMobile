...
import com.blackout.scrumify.GestionProjets.Entities.XYMultipleSeriesEditor;
...
public class ProjectStatusChart extends AbstractDemoChart {
    ...
    public Component execute() {
        // init values and dates...
        getDataSet();
        int length = values.get(0).length;
        int[] colors = new int[]{ColorUtil.BLUE, ColorUtil.GREEN};
        PointStyle[] styles = new PointStyle[]{PointStyle.POINT, PointStyle.POINT};
        XYMultipleSeriesRenderer renderer = buildRenderer(colors, styles);
        setChartSettings(renderer, "Project work status", "Date", "Tasks", dates.get(0)[0].getTime(),
