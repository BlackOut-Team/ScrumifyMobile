 ...
 * @author Hidaya
 */
public class DoneForm extends SideMenuBaseForm {

    public static Resources res;

    public DoneForm(Resources res) {
        super(BoxLayout.y());
...
//        });
        ...
        if (!listT.isEmpty()) {
            ...
            ct.add(empty);
            ct.add(new Label("No tasks here !", "TodayTitle"));
        ...
        doing.addActionListener((evt) -> {

            new DoingForm(res).show();;
